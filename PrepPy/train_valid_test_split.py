...
def train_valid_test_split(X, y, valid_size=0.25, test_size=None, stratify=None, random_state=None, shuffle=True):
    """
    Splits arrays or matrices into random train, validation and test subsets
    The proprotion of the train set relative to the input data will be valid_size * (1 - test)
    ....
    ...
    test_size: float or None, optional (default=None)
        float, a value between 0.0 and 1.0 to represent the proportion of the input dataset to
